    ...
    */
    ...
    protected function credentials(Request $request)
    {
        if ($request->get('phone') != null) {
            ...
            if ($user) {
                return ['phone' => "+{$request['country_code']}{$request['phone']}", 'password' => $user->hashed_password];
            } else {
                $user_name = "guest" . "+{$request['country_code']}{$request['phone']}";
                ...
                $new_user = User::create([
                    ...
                    'generated_by_system' => '1',
                ]);
                return ['phone' => "+{$request['country_code']}{$request['phone']}", 'password' => $new_user->hashed_password];
            }
            ...
            if ($user) { 
                ...
                return ['email' =>  $new_user->email , 'password' => $new_user->hashed_password];
            }
        }
    }
