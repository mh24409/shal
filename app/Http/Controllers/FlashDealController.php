...
class FlashDealController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $flash_deal->small_slug = $request->small_slug;
        ...
        $flash_deal->small_image = $request->small_image;
        if($flash_deal->save()){
            ...
            $flash_deal_translation->description = $request->description;
            $flash_deal_translation->small_slug = $request->small_slug;
    ...
    public function update(Request $request, $id)
    {
        ...
        if($flash_deal->save()){
            ...
            $sub_category_translation->description = $request->description;
            $sub_category_translation->small_slug = $request->small_slug;
