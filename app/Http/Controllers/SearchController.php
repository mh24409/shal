...
class SearchController extends Controller
{
    ...
    { 
        ...
        if ($request->ajax()) {
            return view('frontend.partials.paginate_product_listing', compact('products','selected_season','selected_fabric_type','selected_hand_type','selected_close_type','categories' ,'selected_event','selected_design', 'selected_tag' ,'query', 'category_id', 'brand_id', 'sort_by', 'seller_id', 'min_price', 'max_price', 'attributes', 'selected_attribute_values', 'colors', 'selected_color'));
        }
        return view('frontend.product_listing', compact('products','categories','selected_season','selected_fabric_type','selected_hand_type','selected_close_type' ,'selected_event','selected_design','selected_tag' ,'query', 'category_id', 'brand_id', 'sort_by', 'seller_id', 'min_price', 'max_price', 'attributes', 'selected_attribute_values', 'colors', 'selected_color'));
    }
    ...
    public function ajax_search(Request $request)
    {
        ...
        $stock_product_ids = ProductStock::where('sku', 'like', '%' . $query . '%')->pluck('id');
        if($stock_product_ids->isNotEmpty()) {
            $products_sku = filter_products(Product::whereIn('id', $stock_product_ids)->get());
            $products = $products->concat($products_sku);
        }
