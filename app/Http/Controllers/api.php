...
Route::group(['prefix' => 'v2', 'middleware' => ['app_language']], function () {
    ...
    Route::get('purchase-history-items/{id}', 'App\Http\Controllers\Api\V2\PurchaseHistoryController@items');
    ...
    Route::post('destroy_multiple_items', 'App\Http\Controllers\Api\V2\CartController@destroy_multiple_items');
    ...
    Route::post('/check_cache','App\Http\Controllers\Api\V2\ProductController@check_cache');
    Route::get('get_coupons', 'App\Http\Controllers\Api\V2\DigitalProductController@get_coupons');
    Route::post('/check_phone', 'App\Http\Controllers\Api\V2\AuthController@check_phone')->name('check_phone');
    Route::post('/sign_up_otp', 'App\Http\Controllers\Api\V2\AuthController@sign_up_otp')->name('sign_up_otp');
    Route::post('/login_otp', 'App\Http\Controllers\Api\V2\AuthController@login_otp')->name('login_otp');
    Route::get('/addlast', 'App\Http\Controllers\Api\V2\ProductController@addlast2');
});
...
Route::post('/products/store_via_pos_system', [ProductController::class,'store_via_pos_system']);
Route::post('/products/update_via_pos_system', [ProductController::class,'update_via_pos_system']);
Route::post('/products/delete_via_pos_system', [ProductController::class,'delete_via_pos_system']);

Route::post('/products/update_stock_via_pos', [ProductController::class,'update_stock_via_pos']);
Route::post('/products/update_plus_stock_via_pos', [ProductController::class,'update_plus_stock_via_pos']);
Route::post('/products/update_minus_stock_via_pos', [ProductController::class,'update_minus_stock_via_pos']);
Route::post('/products/delete_stock_via_pos', [ProductController::class,'delete_stock_via_pos']);
