    ...
    public function getList(Request $request)
    {
        ...
        if ($list == "online" || $list == "both") {
            ...
            if (get_setting('myfatoorah') == 1) {
                ...
                $payment_type['title'] = "Checkout with myfatoorah";
                $payment_type['offline_payment_id'] = 0;
                $payment_type['details'] = "";
                if ($mode == 'wallet') {
                    $payment_type['title'] = "Recharge with myfatoorah";
                }
            ...
            if (get_setting('tamara_payment') == 1) {
                $payment_type = array();
                $payment_type['payment_type'] = 'tamara_payment';
                $payment_type['payment_type_key'] = 'Tamara';
                $payment_type['image'] = static_asset('assets/img/cards/tamara-logo-badge-ar.png');
                $payment_type['name'] = "Flutterwave";
                $payment_type['title'] = "Checkout with Tamara";
                $payment_type['offline_payment_id'] = 0;
                $payment_type['details'] = "";
