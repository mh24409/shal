...
class CartController extends Controller
{
    ...
    public function destroy_multiple_items(Request $request)
    {
...
$cartItemIdsArray = array_map(function ($id) {
    return intval(trim($id));
}, explode(',', $cartItemIds));

if (empty($cartItemIdsArray)) {
    return response()->json(['error' => 'Invalid cart item IDs'], 400);
}

// Remove cart items
$user->carts()->whereIn('id', $cartItemIdsArray)->delete();
