...
class User extends Authenticatable implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'address', 'city', 'postal_code', 'generated_by_system', 'phone', 'country', 'provider_id', 'email_verified_at', 'verification_code' ,'hashed_password' ,'otp_expire_at','state'
    ];
