    ...
    <form action="{{ route('reviews.store') }}" method="POST" >
        ...
        <div class="modal-body">
            ...
            <div class="form-group d-flex align-items-center">
                <label class=" d-flex align-items-center"><span>{{ translate('Your Rating')}}</span> <span class="fs-20 text-primary" >*</span></label>
                <div class="rating rating-input mx-3">
                    <label>
                        <input type="radio" name="rating" value="1" required>
                        <i class="fs-20 las la-star"></i>
                    </label>
                    <label>
