{{-- <div class="aiz-user-sidenav-wrap position-relative z-1 rounded-0">
    <div class="aiz-user-sidenav overflow-auto c-scrollbar-light px-4 pb-4">
        ...
        <!-- Menus -->
        <div class="sidemnenu">
            <ul class="aiz-side-nav-list mb-3 pb-3  " data-toggle="aiz-side-menu">
                <!-- Dashboard -->
            ...
            <!-- logout -->
            <a href="{{ route('logout') }}" class="btn btn-primary main_add_to_cart_button btn-block fs-14 fw-700 mb-5 mb-md-0" >{{ translate('Sign Out') }}</a>
        </div>

    </div>
</div> --}}

<div class="aiz-top-menu-sidebar-user-side-nav collapse-sidebar-wrap sidebar-all sidebar-left z-1035">
    <div class="overlay overlay-fixed dark c-pointer" data-toggle="class-toggle"
        data-target=".aiz-top-menu-sidebar-user-side-nav" data-same=".hide-top-menu-bar"></div>
    <div style="overflow: visible;"
        ...
        <button type="button" class=" hide-top-menu-bar close-sidebar" data-toggle="class-toggle"
            data-target=".aiz-top-menu-sidebar-user-side-nav">
            <i class="fa-solid fa-angle-left"></i>
        </button>
        <div class="w-100">
            <div class="sidemnenu w-100 ">
                <ul class="aiz-side-nav-list my-3 pb-3  " data-toggle="aiz-side-menu">
                    <!-- Dashboard -->
                    <li class="aiz-side-nav-item mb-4">
                            ...
                            <a href="{{ route('customer_refund_request') }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    ...
                                    <g id="Group_8107" data-name="Group 8107"
                                        transform="translate(-134.153 -539.823)">
                    ...
                    <li class="aiz-side-nav-item mb-4">
                        <a href="{{ route('compare') }}"
                            ...
                            <svg id="Group_22071" data-name="Group 22071" xmlns="http://www.w3.org/2000/svg"
                                width="14.6" height="16" viewBox="0 0 14.6 16">
                                <g id="LWPOLYLINE" transform="translate(0.158)">
                    ...
                    @if (get_setting('classified_product') == 1)
                        <li class="aiz-side-nav-item d-none">
                            <a href="{{ route('customer_products.index') }}"
                                class="aiz-side-nav-link {{ areActiveRoutes(['customer_products.index', 'customer_products.create', 'customer_products.edit']) }}">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16.002" height="16.001"
                                    viewBox="0 0 16.002 16.001">
                                    <g id="Group_24750" data-name="Group 24750"
                                        transform="translate(-242.999 -1172.998)">
                                        <g id="Group_24748" data-name="Group 24748" transform="translate(85 -22)">
                                            <path id="Subtraction_183" data-name="Subtraction 183"
                                                d="M16260.5,1270h-5a1.5,1.5,0,0,1,0-3h5a1.5,1.5,0,1,1,0,3Zm-5-2a.5.5,0,0,0,0,1h5a.5.5,0,1,0,0-1Z"
                                                transform="translate(-16096 -67)" fill="#b5b5bf" />
                                            <path id="Subtraction_180" data-name="Subtraction 180"
                                                d="M16256,1271a2,2,0,1,1,2-2A2,2,0,0,1,16256,1271Zm0-3a1,1,0,1,0,1,1A1,1,0,0,0,16256,1268Z"
                                                transform="translate(-16094 -72)" fill="#b5b5bf" />
                                        </g>
                                        <g id="Group_24749" data-name="Group 24749" transform="translate(93 -14)">
                                            <path id="Subtraction_182" data-name="Subtraction 182"
                                                d="M16252.5,1262h-5a1.5,1.5,0,1,1,0-3h5a1.5,1.5,0,1,1,0,3Zm-5-2a.5.5,0,0,0,0,1h5a.5.5,0,0,0,0-1Z"
                                                transform="translate(-16088 -59)" fill="#b5b5bf" />
                                            <path id="Subtraction_181" data-name="Subtraction 181"
                                                d="M16248,1263a2,2,0,1,1,2-2A2,2,0,0,1,16248,1263Zm0-3a1,1,0,1,0,1,1A1,1,0,0,0,16248,1260Z"
                                                transform="translate(-16086 -64)" fill="#b5b5bf" />
                                        </g>
                                        <path id="Subtraction_174" data-name="Subtraction 174"
                                            d="M16418,892h-1v-1a4,4,0,0,0-4-4h-1v-1h1a5.006,5.006,0,0,1,5,5v1Z"
                                            transform="translate(-16159 287)" fill="#b5b5bf" />
                                        <path id="Subtraction_176" data-name="Subtraction 176"
                                            d="M6,6H5V5A4,4,0,0,0,1,1H0V0H1A5.005,5.005,0,0,1,6,5V6Z"
                                            transform="translate(249 1188.963) rotate(180)" fill="#b5b5bf" />
                                    </g>
                                </svg>
                                <span class="aiz-side-nav-text ml-3">{{ translate('Classified Products') }}</span>
                            </a>
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <g id="Group_25000" data-name="Group 25000" transform="translate(-240.535 -537)">
                                    <path id="Path_2961" data-name="Path 2961"
                                        d="M221.069,0a8,8,0,1,0,8,8,8,8,0,0,0-8-8m0,15a7,7,0,1,1,7-7,7,7,0,0,1-7,7"
                                        transform="translate(27.466 537)" fill="#b5b5bf" />
                                    <rect id="Rectangle_18942" data-name="Rectangle 18942" width="8"
                                        height="1" rx="0.5" transform="translate(244.535 544.5)"
                                        fill="#b5b5bf" />
                                </g>
                            </svg>
                            <span class="aiz-side-nav-text ml-3">{{ translate('Delete My Account') }}</span>
                ...
                <!-- logout -->
                <a href="{{ route('logout') }}"
                    class="btn btn-primary main_add_to_cart_button btn-block fs-14 fw-700 mb-5 mb-md-0">{{ translate('Sign Out') }}</a>
            </div>
        </div>
    </div>
</div>
