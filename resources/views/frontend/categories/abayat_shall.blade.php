    ...
    <div class="container" style="overflow: visible;">
        <div class="row mt-5">
            <div class="col-lg-6">
                <ul class="breadcrumb bg-transparent p-0 justify-content-start justify-content-lg-start">
                    ...
                    <li class="  breadcrumb-item">
                        <a class="h5 fs-14 fw-700 text-dark mb-0 text-capitalize">{{ translate('abayat shal') }}</a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="row ">
            <div class="col-md-6 category-img d-flex align-items-end justify-content-center position-relative">
                <img class="w-100 animated-banner-img"  src="{{ uploaded_asset(get_setting('abayat_shal_image')) }}" alt="">
            ...
            <div class="col-md-6 d-flex flex-column align-items-center justify-content-center mt-5">
                <div class="title h5 fs-25 fw-700 text-dark mb-0 text-capitalize mb-3  w-100 ">
                    {!! get_setting('abayat_shal__slug') !!}
                </div>
            </div>
        </div>
        <div class="row mt-5">
            <div class="col-md-6 h5 fs-25 text-dark mb-3 text-capitalize">
                {!! get_setting('abayat_shal_quality') !!}
            </div>
            <div class="col-md-6 h5 fs-25 text-dark mb-3 text-capitalize">
                {!! get_setting('ab_sh_description_to_store') !!}
            </div>
        </div> 
        <div style="color: #2d2d2d;font-size: 28px !important;"
                            class="title h5 mb-2 fw-700 text-capitalize">
            {{ translate('What is the selection of abayas and their features available in the Shal store?') }}
        </div>
                ...
                @if ($key % 2 == 0)
                    <section class="row mt-5">
                        <div class="col-md-3 section-from-db p-2 order1"> 
                            <div style="font-size: 26px;" class="title h5 fs-25 mb-2 fw-700 text-capitalize">
        ...
        @endforeach
        <div>
            {!! get_setting('abayat_shal_discussion') !!}
        </div>
        <div class="">
