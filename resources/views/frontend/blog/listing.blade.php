                ...
                <div class="col-xl-9 order-xl-1">
                    ...
                    <div class="blog card-columns">
                        @foreach ($blogs as $blog)
                            <div class="card mb-4 overflow-hidden hov-scale-img p-3">
                                <h2 class="fs-16 fw-700 mb-3 h-40px text-truncate-2">
                                    <a href="{{ url('blog') . '/' . $blog->slug }}" class="text-reset hov-text-primary"
                                        title="{{ $blog->title }}">
                                        {{ $blog->title }}
                                    </a>
                                </h2>
                                ...
                                <div class="py-3">
                                    <a href="{{ url('blog') . '/' . $blog->slug }}"
                                        class="text-reset text-center d-block overflow-hidden h-300px mb-2">
                                    ...
                                    <div>
                                        <small
                                            class="fs-12 fw-400 opacity-60">{{ date('M d, Y', strtotime($blog->created_at)) }}</small>
                                    </div>
                                    @if ($blog->category != null)
                                        <div>
                                            <small
                                                class="fs-12 fw-400 text-blue">{{ $blog->category->category_name }}</small>
                                        </div>
                                    @endif
                                    <div class="mt-3 text-primary">
                                        <a href="{{ url('blog') . '/' . $blog->slug }}"
                                            class="fs-14 fw-700 text-primary has-transition d-flex align-items-center hov-column-gap-1">
                ...
                <div class="col-xl-3">
                    <form class="mb-4" id="search-form" action="" method="GET">
                        <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035 ">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left p-1" style="overflow-y: auto;">
                                ...
                                <!-- Search -->
                                <div class="mb-4 mt-3 px-3 mt-xl-0 px-xl-0 shadow_and_border-raduis">
                                    <div class="input-group w-100">
                                        <input type="text" class="border-0 fs-14 flex-grow-1" name="search"
                                            value="{{ $search }}" placeholder="{{ translate('Search...') }}"
                                            autocomplete="off" style="padding: 14px;">
                                        <div class="input-group-append">
                                            <button class="btn bg-transparent hov-bg-light " type="submit" style="">
                                ...
                                <!-- Categories -->
                                <div class="bg-white   mb-3 mx-3 mx-xl-0 shadow_and_border-raduis">
                    ...
                    <!-- recent posts -->
                    <div class="p-3 shadow_and_border-raduis">
                                    ...
                                    <div class="row">
                                        <div class="col-4">
                                            <a href="{{ url('blog') . '/' . $recent_blog->slug }}"
                                                class="text-reset d-block overflow-hidden w-100 mr-2">
                                                <img src="{{ static_asset('assets/img/placeholder-rect.jpg') }}"
                                        ...
                                        <div class="col-8">
                                            <h2 class="fs-14 fw-700 mb-3 h-35px text-truncate-2">
                                                <a href="{{ url('blog') . '/' . $recent_blog->slug }}"
                                                    class="text-reset hov-text-primary" title="{{ $recent_blog->title }}">
                                                    {{ $recent_blog->title }}
                                                </a>
                                            </h2>
                                            <div>
                                            ...
                                            @if ($recent_blog->category != null)
                                                <div>
                                                    <small
                                                        class="fs-12 fw-400 text-blue">{{ $recent_blog->category->category_name }}</small>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
