                ...
                <div class="col-lg-8">
                    <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST"
                        ...
                        <div class="card rounded-0 border shadow-none">
                            ...
                            <div class="form-group px-4" style="padding-top: 30px;">
                                <input name="name" id="client_name" type="text" required
                                    class="form-control rounded-0" placeholder="{{ translate('Type your Name...') }}">
                            ...
                            <div class="form-group px-4">
                                <input name="phone" type="phone" id="phone_number" required
                                    class="form-control rounded-0" placeholder="{{ translate('Type your Phone...') }}">
                            </div>
                            <div class="form-group px-4">
