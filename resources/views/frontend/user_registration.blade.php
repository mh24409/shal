                            ...
                            <form class="form-default loginRegisterForm" role="form" action="{{ route('login') }}"
                                ...
                                @if (addon_is_activated('otp_system') && env('DEMO_MODE') != 'On')
                                    <div class="form-group phone-form-group mb-1">
                                        ...
                                        <input type="tel" id="phone-code"
                                            class="form-control fs-10 {{ $errors->has('phone') ? ' is-invalid' : '' }} rounded-0"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 d-flex justify-content-end">
                                                <label class="aiz-checkbox">
                                                    ...
                                                    <span class="aiz-square-check" style="width:15px;height:15px;margin:8px 7px" ></span>
                                                </label>
                                            </div>
                                        </div>
                                        <input type="email"
                                    ...
                                    <div class="form-group text-right">
                                        <button class="btn btn-link p-0 text-primary fs-10 " type="button"
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-6">
                                            <label for="password"
                                                class="fs-10 fw-700 text-soft-dark">{{ translate('Password') }}</label>
                                        </div>
                                        <div class="col-6 d-flex justify-content-end">

                                            <a href="{{ route('password.request') }}"
                                                class="text-reset fs-10 fw-400 text-gray-dark hov-text-primary"><u>{{ translate('Forgot password?') }}</u></a>
                                        </div>
                                    </div>
                            ...
                            <form id="reg-form" class="form-default loginRegisterForm" role="form"
                                ...
                                <div class="form-group">
                                    <label for="password"
                                        class="fs-10 fw-700 text-soft-dark">{{ translate('Password') }}</label>
                                    <input type="password"
                                        class="form-control fs-10 rounded-0{{ $errors->has('password') ? ' is-invalid' : '' }}"
                                        placeholder="{{ translate('Password') }}" name="password">
                                    <div class="text-right mt-1">
                                        <span
                                            class="fs-10 fw-400 text-gray-dark">{{ translate('Password must contain at least 6 digits') }}</span>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label for="password_confirmation"
                                        class="fs-10 fw-700 text-soft-dark">{{ translate('Confirm Password') }}</label>
                                    <input type="password" class="form-control fs-10 rounded-0"
                                ...
                                <div class="mb-3">
                                    <label class="aiz-checkbox">
                                        ...
                                        <span class=" fs-10">{{ translate('By signing up you agree to our ') }}
                                            <a href="{{ route('terms') }}"
                                                class="fw-500">{{ translate('terms and conditions.') }}</a></span>
                                        <span class="aiz-square-check"
                                            style="width: 15px;height: 15px;margin: 10px 4px;"
                                        ></span>
                                    </label>
                                </div>
