        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                <div class="modal-content pb-4">
                    ...
                    <form class="" action="{{ route('products_reports.home') }}" id="sort_orders" method="GET">
                                                <div>
            ...
            <div class="row" style="box-shadow: rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px;">
                    ...
                    <div class="bg-white text-dark rounded-lg overflow-hidden">
                        <div class="px-3 pt-3">
                            <div class="opacity-50 fs-18 fw-bold mb-3">
                                <span class="fs-12 d-block">{{ translate('all Products') }}
                            </div>
                ...
                <div class="col-lg-4 col-6 border p-0   ">
                    <div class="bg-white text-dark rounded-lg overflow-hidden">
                        <div class="px-3 pt-3">
                            <div class="opacity-50 fs-18 fw-bold mb-3">
                                <span class="fs-12 d-block">{{ translate('Total Orders Order') }}
                            </div>
                            <div class="h3 fw-700 mb-3">
                                <span>
                                    <svg xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 64 64"
                ...
                <table id="myTable" class="table table-striped w-100 ">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">{{ translate('category Name') }}</th>
                    ...
                    <tbody>
                        @foreach ($order as $item)
                            <tr>
                                ...
                                <td> {{ $item->product->name  ??  translate('Product Not Found') }}</td>
                                <td> {{ $item->product->category->name ??  translate('category Not Found') }}</td>
                                <td>
                                    <a
                                        href="{{ $item->product ? route('reports.showproduct', ['id' => $item->product->id,
                                        'date' => isset($sort_date) ? $sort_date : 0]) : '#' }}">{{ $item->order_count }}</a>
                                </td>
