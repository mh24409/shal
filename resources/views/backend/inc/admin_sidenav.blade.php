        ...
        <div class="aiz-side-nav-wrap">
            ...
            <ul class="aiz-side-nav-list" id="main-menu" data-toggle="aiz-side-menu">
                ...
                @canany(['add_new_product', 'show_all_products','show_in_house_products','show_seller_products','show_digital_products','product_bulk_import','product_bulk_export','view_product_categories', 'view_all_brands','view_product_attributes','view_colors','view_product_reviews'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endcan
                             @can('add_new_product')
                                <li class="aiz-side-nav-item d-none">
                                    <a class="aiz-side-nav-link" href="{{route('products.create_barcode')}}">
                                        <span class="aiz-side-nav-text">{{translate('Print Product barcode')}}</span>
                                    </a>
                                </li>
                            @endcan
                            ...
                            @endcan
                            @can('show_best_selling')
                            <li class="aiz-side-nav-item">
                                <a href="{{route('products.best_selling_index')}}" class="aiz-side-nav-link">
                                    <span class="aiz-side-nav-text">{{ translate('Best selling') }}</span>
                                </a>
                            </li>
                   @endcan
                            ...
                            @can('show_all_products')
                                <li class="aiz-side-nav-item">
                                    <a href="{{route('questions_answers.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['questions_answers.index', 'questions_answers.create', 'questions_answers.edit'])}}" >
                                        <span class="aiz-side-nav-text">{{translate('Product Questions & Answer')}}</span>
                                    </a>
                                </li>
                            @endcan
                        </ul>
                ...
                <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('reports.home') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Main Reports') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('order_reports.home') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Order Reports') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('category_reports.home') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Category reports') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{ route('products_reports.home') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Products reports') }}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item d-none">
                            <a href="{{ route('reports.pagesview') }}" class="aiz-side-nav-link">
                                <span class="aiz-side-nav-text">{{ translate('Pages reports') }}</span>
                            </a>
                        </li>
                       ...
                       <li class="aiz-side-nav-item">
                            <a href="{{ route('profitReport.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['profitReport.index'])}}">
                ...
                @canany(['view_all_flash_deals','send_newsletter','send_bulk_sms','view_all_subscribers','view_all_coupons'])
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @endif
                            <li class="aiz-side-nav-item d-none">
                                <a href="{{route('catalog.create')}}" class="aiz-side-nav-link {{ areActiveRoutes(['catalog.index','catalog.create','catalog.edit'])}}">
                                    <span class="aiz-side-nav-text">{{ translate('Facebook Catalog') }}</span>
                                </a>
                            </li>
                            ...
                            @canany(['shipping_configuration','shipping_country_setting','manage_shipping_states','manage_shipping_cities','manage_zones','manage_carriers'])
                                <li class="aiz-side-nav-item">
                                    ...
                                    <ul class="aiz-side-nav-list level-3">
                                        ...
                                        @endcan
                                            <li class="aiz-side-nav-item">
                                                <a href="{{route('jana_city_attach')}}" class="aiz-side-nav-link {{ areActiveRoutes(['jana_city_attach','jana_city_attach'])}}">
                                                    <span class="aiz-side-nav-text">{{translate('Jana Cities')}}</span>
                                                </a>
                                            </li>
                                            <li class="aiz-side-nav-item">
                                                <a href="{{route('aymakan_city_attach')}}" class="aiz-side-nav-link {{ areActiveRoutes(['aymakan_city_attach','aymakan_city_attach'])}}">
                                                    <span class="aiz-side-nav-text">{{translate('Aymakan Cities')}}</span>
                                                </a>
                                            </li>
