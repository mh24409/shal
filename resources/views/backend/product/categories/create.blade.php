                    ...
                    <form class="form-horizontal" action="{{ route('categories.store') }}" method="POST"
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{ translate('Banner') }}
                                <small>({{ translate('w 350 x h 250') }})</small></label>
                            <div class="col-md-9">
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{ translate('Cover Image') }}
                                <small>({{ translate('w 387 x h 800') }})</small></label>
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    <div class="input-group-prepend">
                                        <div class="input-group-text bg-soft-secondary font-weight-medium">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="description_to_store"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('the Quality') }}</label>
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="quality"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Long Slug') }}</label>
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="long_slug"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Discussion') }}</label>
                            <div class="col-md-8">
                                <textarea class="aiz-text-editor" name="discussion"></textarea>
                            </div>
                        </div>
