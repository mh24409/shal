        ...
        <div class="card">
            <div class="card-body p-0">
                ...
                <form class="p-4" action="{{ route('categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
    	            ...
    	            <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Banner')}} <small>({{ translate('w 350 x h 250') }})</small></label>
                        <div class="col-md-9">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Icon')}} <small> </small></label>
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 col-form-label" for="signinSrEmail">{{translate('Cover Image')}} <small>({{ translate('w 387 x h 800') }})</small></label>
                        <div class="col-md-9">
                            <div class="input-group" data-toggle="aizuploader" data-type="image">
                                <div class="input-group-prepend">
                                    <div class="input-group-text bg-soft-secondary font-weight-medium">{{ translate('Browse')}}</div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <textarea class="aiz-text-editor" name="description">{{ $category->getTranslation('description', $lang) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('The Quality') }}</label>
                        <div class="col-md-8">
                            <textarea class="aiz-text-editor" name="quality">{{ $category->getTranslation('quality', $lang) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Long Slug') }}</label>
                        <div class="col-md-8">
                            <textarea class="aiz-text-editor" name="long_slug">{{ $category->getTranslation('long_slug', $lang) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('description_to_store') }}</label>
                        <div class="col-md-8">
                            <textarea class="aiz-text-editor" name="description_to_store">{{ $category->getTranslation('description_to_store', $lang) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-md-3 col-from-label">{{ translate('Discussion') }}</label>
                        <div class="col-md-8">
                            <textarea class="aiz-text-editor" name="discussion">{{ $category->getTranslation('discussion', $lang) }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
