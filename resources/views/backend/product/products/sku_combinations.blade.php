                    ...
                    <tr class="variant">
                        ...
                        <td>
                            <input type="number" lang="en" name="price_{{ $str }}"
                                value="{{ $unit_price }}" min="0" step="0.01" class="form-control"
                                required>
                        </td>
                        {{-- <td>
                            <input type="number" lang="en" name="Wholesale_price_{{ $str }}"
                                value="{{ $wholesale_price }}" min="0" step="0.01" class="form-control"
                                required>
                        </td>
                        <td>
                            <input type="number" lang="en" name="Wholesale_price_variant_{{ $str }}"
                                value="{{ $wholesale_price_variant }}" min="0" step="0.01" class="form-control" required>
                        </td> --}}
                        <td>
                            <input type="number" lang="en" name="cost_price_{{ $str }}"
                                value="{{ $cost_price }}" min="0" step="0.01" class="form-control" required>
                        </td>
                        <td>
                            <input type="radio" id="{{ $str }}" name="default_variation" value="{{ $str }}">
                        </td>
                        <td>
