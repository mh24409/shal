...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-10 mx-auto">
                    ...
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="home-slider-target">
                                ...
                                <input type="hidden" name="types[]" value="home_slider_video_link">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        name="home_slider_video_link[]"
                                                        value="{{ json_decode(get_setting('home_slider_video_link'), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <input type="hidden" name="types[]" value="home_slider_title">
                                                    <input type="text" class="form-control"
                                                        placeholder="{{ translate('title') }}" name="home_slider_title[]"
                                                        value="{{ json_decode(get_setting('home_slider_title'), true)[$key] }}">
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        ...
                                                        value="{{ json_decode(get_setting('home_slider_subtitle'), true)[$key] }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Home Banner 1') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    @foreach (json_decode(get_setting('home_banner1_images'), true) as $key => $value)
                                        <div class="row gutters-5">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group" data-toggle="aizuploader" data-type="image">
                                                        <div class="input-group-prepend">
                                                            <div
                                                                class="input-group-text bg-soft-secondary font-weight-medium">
                                                                {{ translate('Browse') }} ( w 350 x h 250 ) </div>
                                                        </div>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <input type="hidden" name="types[]" value="home_banner1_text">
                                                    <textarea class="aiz-text-editor form-control" placeholder="{{ translate('section text') }}" name="home_banner1_text">
                                                        {{ get_setting('home_banner1_text') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
            ...
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('Home Banner 2') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    @foreach (json_decode(get_setting('home_banner2_images'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <input type="hidden" name="types[]" value="home_banner2_text">
                                                    <textarea class="aiz-text-editor form-control" placeholder="{{ translate('section text') }}" name="home_banner2_text">
                                                        {{ get_setting('home_banner2_text') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                    ...
                    <div class="card-body">
                        <form action="{{ route('business_settings.update') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="#292933"
...
@endforeach
            ...
            {{-- section one spacific category --}}
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('section one') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST"
                        enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>{{ translate('Categories') }}</label>
                            <div class="home-categories-target">
                                <input type="hidden" name="types[]" value="section_one_category">
                                <input type="hidden" name="types[]" value="section_one_text">
                                <input type="hidden" name="types[]" value="section_one_title">
                                <input type="hidden" name="types[]" value="section_one_link">
                                        ...
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <select class="form-control aiz-selectpicker"
                                                        name="section_one_category[]" data-live-search="true"
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="hidden" name="types[]" value="section_one_title">
                                                    <textarea class="aiz-text-editor form-control" placeholder="{{ translate('section title') }}" name="section_one_title">
                                                        {{ get_setting('section_one_title') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label>{{ translate('section text') }}</label>
                                                    <input type="hidden" name="types[]" value="section_one_text">
                                                    <input type="hidden" name="types[]" value="section_one_text">
                                                        <textarea class="aiz-text-editor form-control" placeholder="{{ translate('section text') }}"
                                                    name="section_one_text">
                                                        {{ get_setting('section_one_text') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label>{{ translate('section link') }}</label>
                                                    <input type="hidden" name="types[]" value="section_one_link">
                                                    <input type="text" class="form-control" placeholder="https://"
                                                        name="section_one_link"
                                                        value="{{ get_setting('section_one_link') }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
            ...
            {{-- section two spacific category --}}
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('section two') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST"
                        enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>{{ translate('Categories') }}</label>
                            <div class="home-categories-target">
                                <input type="hidden" name="types[]" value="section_two_category">
                                <input type="hidden" name="types[]" value="section_two_text">
                                <input type="hidden" name="types[]" value="section_two_title">
                                <input type="hidden" name="types[]" value="section_two_link">
                                    ...
                                    @foreach (json_decode(get_setting('section_two_category'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <select class="form-control aiz-selectpicker"
                                                        name="section_two_category[]" data-live-search="true"
                                                        data-selected={{ $value }} required>
                                                        @foreach (\App\Models\Category::where('parent_id', 0)->with('childrenCategories')->get() as $category)
                                                            <option value="{{ $category->id }}">
                                                                {{ $category->getTranslation('name') }}</option>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label>{{ translate('section title') }}</label>
                                                    <input type="hidden" name="types[]" value="section_two_title">
                                                    <textarea class="aiz-text-editor form-control" placeholder="{{ translate('section title') }}" name="section_two_title">
                                                        {{ get_setting('section_two_title') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    name="section_two_text">
                                                        {{ get_setting('section_two_text') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="https://"
                                                        ...
                                                        value="{{ get_setting('section_two_link') }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
            ...
            {{-- section three spacific category --}}
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('section three') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST"
                        enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>{{ translate('Categories') }}</label>
                            <div class="home-categories-target">
                                <input type="hidden" name="types[]" value="section_three_category">
                                <input type="hidden" name="types[]" value="section_three_text">
                                <input type="hidden" name="types[]" value="section_three_title">
                                <input type="hidden" name="types[]" value="section_three_link">
                                    ...
                                    @foreach (json_decode(get_setting('section_three_category'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <select class="form-control aiz-selectpicker"
                                                        name="section_three_category[]" data-live-search="true"
                                                        data-selected={{ $value }} required>
                                                        @foreach (\App\Models\Category::where('parent_id', 0)->with('childrenCategories')->get() as $category)
                                                            <option value="{{ $category->id }}">
                                                                {{ $category->getTranslation('name') }}</option>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label>{{ translate('section title') }}</label>
                                                    <input type="hidden" name="types[]" value="section_three_title">
                                                    <textarea class="aiz-text-editor form-control" placeholder="{{ translate('section title') }}" name="section_three_title">
                                                        {{ get_setting('section_three_title') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    name="section_three_text">
                                                        {{ get_setting('section_three_text') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="https://"
                                                        ...
                                                        value="{{ get_setting('section_three_link') }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
            ...
            {{-- section four spacific category --}}
            <div class="card">
                <div class="card-header">
                    <h6 class="mb-0">{{ translate('section four') }}</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST"
                        enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>{{ translate('Categories') }}</label>
                            <div class="home-categories-target">
                                <input type="hidden" name="types[]" value="section_four_category">
                                <input type="hidden" name="types[]" value="section_four_text">
                                <input type="hidden" name="types[]" value="section_four_title">
                                <input type="hidden" name="types[]" value="section_four_link">
                                    ...
                                    @foreach (json_decode(get_setting('section_four_category'), true) as $key => $value)
                                        <div class="row gutters-5">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <select class="form-control aiz-selectpicker"
                                                        name="section_four_category[]" data-live-search="true"
                                                        data-selected={{ $value }} required>
                                                        @foreach (\App\Models\Category::where('parent_id', 0)->with('childrenCategories')->get() as $category)
                                                            <option value="{{ $category->id }}">
                                                                {{ $category->getTranslation('name') }}</option>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label>{{ translate('section title') }}</label>
                                                    <input type="hidden" name="types[]" value="section_four_title">
                                                    <textarea class="aiz-text-editor form-control" placeholder="{{ translate('section title') }}"
                                                    name="section_four_title">
                                                        {{ get_setting('section_four_title') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    name="section_four_text">
                                                        {{ get_setting('section_four_text') }}</textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="https://"
                                                        ...
                                                        value="{{ get_setting('section_four_link') }}">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
