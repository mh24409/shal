            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('business_settings.update') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-8">
                                    <div class=" input-group " data-toggle="aizuploader" data-type="image">
                                        ...
                                        <input type="hidden" name="topbar_banner_medium" class="selected-files"
                                            value="{{ get_setting('topbar_banner_medium') }}">
                                    </div>
                                    <div class="file-preview"></div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-8">
                                    <div class=" input-group " data-toggle="aizuploader" data-type="image">
                                        ...
                                        <input type="hidden" name="topbar_banner_small" class="selected-files"
                                            value="{{ get_setting('topbar_banner_small') }}">
                                    </div>
                                    <div class="file-preview"></div>
                                </div>
                            </div>
                        ...
                        <div class="border-top pt-3">
                            <label class="">{{ translate('Header custom small banner') }}</label>
                            <div class="header-nav-menu">
                                <input type="hidden" name="types[]" value="custom_banner_label">
                                <input type="hidden" name="types[]" value="custom_banner_bg">
                                <input type="hidden" name="types[]" value="custom_banner_text_color">
                                <input type="hidden" name="types[]" value="custom_banner_link">
                                <div class="row gutters-5">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                placeholder="{{ translate('Label') }}" name="custom_banner_label"
                                                value="{{ get_setting('custom_banner_label') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                placeholder="linear-gradient(to right, #ED48FF, #00DEFF) !important"
                                                name="custom_banner_bg"
                                                value="{{ get_setting('custom_banner_bg') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <input type="text" class="form-control" placeholder="#ffffff"
                                                name="custom_banner_text_color"
                                                value="{{ get_setting('custom_banner_text_color')}}">
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <input type="text" class="form-control"
                                                placeholder="{{ translate('Link with') }} https://"
                                                name="custom_banner_link" value="{{ get_setting('custom_banner_link')}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
