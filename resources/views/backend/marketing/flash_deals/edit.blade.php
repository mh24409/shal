                    ...
                    <form class="p-4" action="{{ route('flash_deals.update', $flash_deal->id) }}" method="POST">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0 h6">{{ translate('Small Slug') }}</h5>
                            </div>
                            <div class="card-body">
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{ translate('Small Slug') }}</label>
                                    <div class="col-md-8">
                                        <textarea class="aiz-text-editor" name="small_slug">{{ $flash_deal->getTranslation('small_slug', $lang) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <textarea class="aiz-text-editor" name="description">{{ $flash_deal->getTranslation('description', $lang) }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-form-label" for="signinSrEmail">{{ translate('small image') }}
                            ...
                            <div class="col-md-9">
                                <div class="input-group" data-toggle="aizuploader" data-type="image">
                                    ...
                                    <input type="hidden" name="small_image" value="{{ $flash_deal->small_image }}"
