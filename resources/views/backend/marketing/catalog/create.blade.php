...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">{{translate('Add Facebook Catalog')}}</h5>
</div>
...
<div class="col-lg-8 mx-auto">
    <div class="card">
        ...
        @endif --}}
        <form method="POST" id="add_review_form" action="{{route('catalog.store')}}">
            @csrf
            <div class="container my-2">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="randomText" name="password" value="{{old('catalog_name')}}" class="form-control">
                        @error('catalog_name')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
            ...
            <div class="m-3">
                ...
                <select class="select2 form-control aiz-selectpicker" name="products[]" multiple data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
