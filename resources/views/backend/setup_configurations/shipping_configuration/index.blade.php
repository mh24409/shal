...
<div class="row">
    <div class="col-lg-6">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Shipping Profit')}}</h5>
            </div>
            <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                  @csrf
                  <input type="hidden" name="type" value="shipping_profit">
                  <div class="form-group">
                      <div class="col-lg-12">
                          <input class="form-control" type="text" name="shipping_profit" value="{{ get_setting('shipping_profit') }}">
                      </div>
                  </div>
                  <div class="form-group mb-0 text-right">
                      <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
...
<div class="row d-none">
    <div class="col-lg-6 ">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Auto Shipping')}}</h5>
            </div>
            <form action="{{ route('shipping_configuration.update') }}" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="type" value="auto_shipping">

              <div class="card-body">
                  @csrf
                  <div class="form-group">
                      <div class="col-lg-12">
                          <label for="auto_shipping" class="checkbox-inline">
                              <input type="checkbox" name="auto_shipping" id="auto_shipping" value="1" {{ get_setting('auto_shipping') == 1 ? 'checked' : '' }}>
                              {{translate('Enable Auto Shipping')}}
                              </label>
                        </div>
                    </div>
                  <div class="form-group mb-0 text-right">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <ul class="list-group">
                    <li class="list-group-item">
                        {{ translate('1. Enabled Auto Shipping Make the order Sent To Shipping Company Automatically.') }}
                    </li>
                </ul>
            </div>
        </div>
