    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0 h6 ">{{translate('Tamara Credential')}}</h5>
                </div>
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        @csrf
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="TAMARA_API_TOKEN">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Tamara Api Token')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="TAMARA_API_TOKEN" value="{{  env('TAMARA_API_TOKEN') }}" placeholder="{{ translate('Tamara Api Token') }}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="TAMARA_CURRENCY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('Tamara Currency')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="TAMARA_CURRENCY" value="{{  env('TAMARA_CURRENCY') }}" placeholder="{{ translate('Tamara Currency') }}" required>
                            </div>
                        </div>
                        <div class="form-group mb-0 text-right">
                            <button type="submit" class="btn btn-sm btn-primary">{{translate('Save')}}</button>
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_API_KEY" value="{{  env('PAYMOB_API_KEY') }}" placeholder="{{ translate('MERCHANT ID') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYMOB_SECRET_KEY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('PAYMOB SECRET KEY')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_SECRET_KEY" value="{{  env('PAYMOB_SECRET_KEY') }}" placeholder="{{ translate('SECRET KEY') }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('PAYMOB MERCHANT ID')}}</label>
                            </div>
                             <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_MERCHANT_ID" value="{{  env('PAYMOB_MERCHANT_ID') }}" placeholder="{{ translate('MERCHANT ID') }}" required>
                            </div>
                        </div>

                        <div class="form-group row">
                            <input type="hidden" name="types[]" value="PAYMOB_CURRENCY">
                            <div class="col-md-4">
                                <label class="col-from-label">{{translate('PAYMOB CURRENCY')}}</label>
                            </div>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="PAYMOB_CURRENCY" value="{{  env('PAYMOB_CURRENCY') }}" placeholder="{{ translate('CURRENCY') }}" required>
                            </div>
                        </div>
                        ...
                        {{-- <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <label class="aiz-switch aiz-switch-success mb-0">
                                    <input value="1" name="paymob_sandbox" type="checkbox" @if (get_setting('paymob_sandbox') == 1)
                                        checked
                                    @endif>
                                    <span class="slider round"></span>
                                </label>
