                ...
                <div class="card-body">
                    <form action="{{ route('cities.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control aiz-selectpicker " id='state_id' name="state_id"
                                data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
                                @foreach ($states as $state)
                                    <option value="{{ $state->id }}" shippingId ="{{ $state->shipping_id }}">
                                        {{ $state->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2 form-control aiz-selectpicker" id='shipping_city' name="shipping_city"
                                data-toggle="select2" data-placeholder="Choose ..." data-live-search="true">
