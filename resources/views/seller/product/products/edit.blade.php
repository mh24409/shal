        ...
        <div class="card-body">
            ...
            <div id="show-hide-div">
                <div class="form-group row">
                    ...
                    <div class="col-lg-6">
                        <input type="number" lang="en" value="{{ optional($product->stocks->first())->qty != null ? optional($product->stocks->first())->qty : 0 }}" step="1"
...
<div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-lg-3 col-from-label">{{translate('Long Description')}} <i class="las la-language text-danger" title="{{translate('Translatable')}}"></i></label>
                            <div class="col-lg-9">
